...
public class SignInActivity extends AppCompatActivity {
    ...
    {
        startActivity(new Intent(SignInActivity.this,About.class));
    }
    public void onFare(View view)
    {
        startActivity(new Intent(SignInActivity.this,Fare.class));
    }
    public void onPlaces(View view)
    {
        startActivity(new Intent(SignInActivity.this,Place.class));
    }
}
